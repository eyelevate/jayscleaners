...
@section('content')
	<div class="panel panel-default">
		...
		<div class="panel-body">
	        ...
	        <div class="form-group{{ $errors->has('search') ? ' has-error' : '' }} search_div">
	            ...
	            <div id="search_container" class="col-md-6 col-lg-6 col-sm-12 col-xs-12">
	                <input id="search_data" type="text" class="form-control" name="search" value="{{ old('search') ? old('search') : $processing_date }}" style="background-color:#ffffff">
		...
		<div class="panel-footer clearfix">
			...
			<a href="#" class="btn btn-lg btn-primary pull-right disabled">Finished</a>
		</div>
	</div>
