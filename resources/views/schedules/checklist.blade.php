						...
						<table class="schedule_table table table-striped table-condensed table-hover">
							...
							if (count($invoices) > 0) {
								...
								<tr id="invoice-{{ $invoice->id }}" class="invoices_tr {{ ($invoice->schedule_id) ? 'success' : '' }}" style="cursor:pointer;">
									...
									<td>{{ $invoice->pretax_html }}</td>
									<td>
										<input class="schedule_ids" type="hidden" value="{{ $dl['id'] }}"/>
										<input class="invoice_ids" type="checkbox" value="{{ $invoice->id }}" {{ ($invoice->schedule_id) ? 'checked="true"' : '' }} />
									</td>
								</tr>
								<?php
							...
							<tfoot>
								<tr>
									<th colspan="4" style="text-align:right">Qty&nbsp;</th>
									<td id="total_qty-{{ $dl['id'] }}">{{ ($dl['invoice_totals']) ? $dl['invoice_totals']['quantity'] : '0' }}</td>
								</tr>
								<tr>
									<th colspan="4" style="text-align:right">Subtotal&nbsp;</th>
									<td id="total_subtotal-{{ $dl['id'] }}">{{ ($dl['invoice_totals']) ? $dl['invoice_totals']['subtotal_html'] : '$0.00' }}</td>
								</tr>
								<tr>
									<th colspan="4" style="text-align:right">Tax&nbsp;</th>
									<td id="total_tax-{{ $dl['id'] }}">{{ ($dl['invoice_totals']) ? $dl['invoice_totals']['tax_html'] : '$0.00' }}</td>
								</tr>
								<tr>
									<th colspan="4" style="text-align:right">Total&nbsp;</th>
									<td id="total_total-{{ $dl['id'] }}">{{ ($dl['invoice_totals']) ? $dl['invoice_totals']['total_html'] : '$0.00' }}</td>
								</tr>
							</tfoot>
						</table>
					</div>
					...
					<div class="table-responsive form-group col-lg-12 col-md-12 col-sm-12 col-xs-12">
						<table class="schedule_table table table-striped table-condensed table-hover">
							...
							<tfoot>
								<tr>
									<th colspan="4" style="text-align:right">Qty&nbsp;</th>
									<td id="total_qty-{{ $dl['id'] }}" class="disabled">{{ ($dl['invoice_totals']) ? $dl['invoice_totals']['quantity'] : '0' }}</td>
								</tr>
								<tr>
									<th colspan="4" style="text-align:right">Subtotal&nbsp;</th>
									<td id="total_subtotal-{{ $dl['id'] }}" class="disabled">{{ ($dl['invoice_totals']) ? $dl['invoice_totals']['subtotal_html'] : '$0.00' }}</td>
								</tr>
								<tr>
									<th colspan="4" style="text-align:right">Tax&nbsp;</th>
									<td id="total_tax-{{ $dl['id'] }}" class="disabled">{{ ($dl['invoice_totals']) ? $dl['invoice_totals']['tax_html'] : '$0.00' }}</td>
								</tr>
								<tr>
									<th colspan="4" style="text-align:right">Total&nbsp;</th>
									<td id="total_total-{{ $dl['id'] }}" class="disabled">{{ ($dl['invoice_totals']) ? $dl['invoice_totals']['total_html'] : '$0.00' }}</td>
								</tr>
							</tfoot>
						</table>
					</div>
			...
			<div class="panel panel-default">
				...
				<div class="panel-body" style="font-size:17px;">
					...
					<div class="table-responsive form-group col-lg-12 col-md-12 col-sm-12 col-xs-12">
						<table class="schedule_table table table-striped table-condensed table-hover">
							...
							<tfoot>
								<tr>
									<th colspan="4" style="text-align:right">Qty&nbsp;</th>
									<td id="total_qty-{{ $al['id'] }}" class="disabled">{{ ($al['invoice_totals']) ? $al['invoice_totals']['quantity'] : '0' }}</td>
								</tr>
								<tr>
									<th colspan="4" style="text-align:right">Subtotal&nbsp;</th>
									<td id="total_subtotal-{{ $al['id'] }}" class="disabled">{{ ($al['invoice_totals']) ? $al['invoice_totals']['subtotal_html'] : '$0.00' }}</td>
								</tr>
								<tr>
									<th colspan="4" style="text-align:right">Tax&nbsp;</th>
									<td id="total_tax-{{ $al['id'] }}" class="disabled">{{ ($al['invoice_totals']) ? $al['invoice_totals']['tax_html'] : '$0.00' }}</td>
								</tr>
								<tr>
									<th colspan="4" style="text-align:right">Total&nbsp;</th>
									<td id="total_total-{{ $al['id'] }}" class="disabled">{{ ($al['invoice_totals']) ? $al['invoice_totals']['total_html'] : '$0.00' }}</td>
								</tr>
							</tfoot>
						</table>
					</div>
					...
					<div class="form-group col-xs-12 col-sm-12 col-md-12 col-lg-12">
						<label class="control-label" style="text-align:right">Delay Delivery</label>
						<p>
						{{ Form::select('reason',$al['delay_list'],'',['class'=>'form-control']) }}
						</p>
						<div>
							<input type="submit" class="btn btn-danger" value="Submit Delay"/>
						</div>
