...
@section('content')
    <br/>
    {!! Form::open(['action' => 'DiscountsController@postAdd','role'=>"form"]) !!}
    <div class="panel panel-default">
    	...
    	<div class="panel-body">
    		<div class="form-group {{ $errors->has('company_id') ? ' has-error' : '' }}">
				...
				{{ Form::select('company_id',$companies,old('company_id') ? old('company_id') : Auth::user()->company_id,['class'=>"form-control"]) }}
			...
			<div class="form-group {{ $errors->has('type') ? ' has-error' : '' }}">
				...
				{{ Form::select('type',['1'=>'Rate Discount','2'=>'Price Discount'],old('type'),['class'=>"form-control",'placeholder'=>'type']) }}
                @if ($errors->has('type'))
                    <span class="help-block">
			...
			<div id="rate" class="form-group {{ $errors->has('rate') ? ' has-error' : '' }}">
				...
				{{ Form::text('rate',old('rate'),['class'=>"form-control",'placeholder'=>'rate']) }}
                @if ($errors->has('rate'))
                    <span class="help-block">
			...
			<div class="form-group {{ $errors->has('inventory_id') ? ' has-error' : '' }}">
				...
				{{ Form::select('inventory_id',$inventories,old('inventory_id'),['class'=>"form-control",'placeholder'=>'Select Inventory Group']) }}
			...
			<div class="form-group {{ $errors->has('inventory_item_id') ? ' has-error' : '' }}">
				...
				{{ Form::select('inventory_item_id',$items,old('inventory_item_id'),['class'=>"form-control",'placeholder'=>'Select Item']) }}
			...
			<div class="form-group {{ $errors->has('start_date') ? ' has-error' : '' }}">
				...
				{{ Form::text('start_date',old('start_date'),['class'=>"datePicker form-control",'placeholder'=>'start_date']) }}
			...
			<div class="form-group {{ $errors->has('end_date') ? ' has-error' : '' }}">
				...
				{{ Form::text('end_date',old('end_date'),['class'=>"datePicker form-control",'placeholder'=>'end_date']) }}
