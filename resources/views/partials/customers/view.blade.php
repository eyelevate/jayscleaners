			...
			<div class="box-body" style="">
				<div class="form-horizontal">
                    ...
                    <div class="form-group{{ $errors->has('phone') ? ' has-error' : '' }}">
                        ...
                        <div class="col-md-6">
                            <input type="text" class="form-control" name="phone" value="" disabled="true" style="font-size:20px; background-color:#ffffff;">
                        </div>
                    </div>
                    <div class="form-group{{ $errors->has('email') ? ' has-error' : '' }}">
                        ...
                        <div class="col-md-6">
                            <input type="text" class="form-control" name="email" value="" disabled="true" style="font-size:20px; background-color:#ffffff;">
                        </div>
                    </div>
                    <div class="form-group{{ $errors->has('street') ? ' has-error' : '' }}">
                        ...
                        <div class="col-md-6">
                            <input type="text" class="form-control" name="street" value="" disabled="true" style="font-size:20px; background-color:#ffffff;">
                        </div>
                    </div>
                    <div class="form-group{{ $errors->has('city') ? ' has-error' : '' }}">
                        ...
                        <div class="col-md-6">
                            <input type="text" class="form-control" name="city" value="" disabled="true" style="font-size:20px; background-color:#ffffff;">
                        </div>
                    </div>
                    <div class="form-group{{ $errors->has('zipcode') ? ' has-error' : '' }}">
                        ...
                        <div class="col-md-6">
                            <input type="text" class="form-control" name="zipcode" value="" disabled="true" style="font-size:20px; background-color:#ffffff;">
                        </div>
                    </div>
				</div>
