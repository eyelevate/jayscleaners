{!! Form::open(['action' => 'InventoriesController@postEdit', 'class'=>'form-horizontal','role'=>"form"]) !!}
	{!! csrf_field() !!}
	{{ Form::hidden('id',null,['class'=>'groupEdit-id']) }}
			...
			<div class="modal-content">
				...
				<div class="modal-body">
	                <div class="form-group{{ $errors->has('company_id') ? ' has-error' : '' }}">
	                    ...
	                    <div class="col-md-6">
	                        {!! Form::select('company_id',$companies , Auth::user()->company_id, ['id'=>'groupEdit-company_id','class'=>'form-control']) !!}
	                ...
	                <div class="form-group{{ $errors->has('name') ? ' has-error' : '' }}">
	                    ...
	                    <div class="col-md-6">
	                        {!! Form::text('name', old('name'), ['id'=>'groupEdit-name','class'=>'form-control', 'placeholder'=>'']) !!}
	                        @if ($errors->has('name'))
	                            <span class="help-block">
	                ...
	                <div class="form-group{{ $errors->has('description') ? ' has-error' : '' }}">
	                    ...
	                    <div class="col-md-6">
	                        {!! Form::textarea('description', old('description'), ['id'=>'groupEdit-description','class'=>'form-control', 'placeholder'=>'']) !!}
