		...
		<div class="modal-content">
			...
			<div class="modal-body clearfix">
	            <div class="form-group{{ $errors->has('amount_due') ? ' has-error' : '' }}">
                    ...
                    {{ Form::text('amount_due','0.00',['id'=>'amount_due_cash','class'=>'amount_due form-control','readonly'=>'true','style'=>'font-size:20px;']) }}
                </div>	
	            ...
	            <div class="form-group{{ $errors->has('change') ? ' has-error' : '' }}">
                    ...
                    {{ Form::text('change','0.00',['id'=>'change','class'=>'form-control','readonly'=>'true','style'=>'font-size:20px;']) }}
                </div>	
			</div>
