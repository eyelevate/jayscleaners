						...
						<div class="description-block border-right">
							@if (count($summaries))
								...
								<div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
									<label class="col-lg-12 col-md-12 col-sm-12 col-xs-12">{{ $summary['name'] }}</label>
									<h5 class="description-header">&nbsp;{{ $summary['today'] }}</h5>
								</div>
								@endforeach
							@endif
						</div>
					...
					<div class="col-sm-6 col-xs-12 col-md-3 col-lg-3">
						...
						<div class="description-block border-right">
							...
							@if (count($summaries))
								...
								<div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
									<label class="col-lg-12 col-md-12 col-sm-12 col-xs-12">{{ $summary['name'] }}</label>
									<h5 class="description-header">&nbsp;{{ $summary['this_week'] }}</h5>
								</div>
								@endforeach
							@endif
					...
					<div class="col-sm-6 col-xs-12 col-md-3 col-lg-3">
						...
						<div class="description-block border-right">
							...
							@if (count($summaries))
								...
								<div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
									<label class="col-lg-12 col-md-12 col-sm-12 col-xs-12">{{ $summary['name'] }}</label>
									<h5 class="description-header">&nbsp;{{ $summary['this_month'] }}</h5>
								</div>
								@endforeach
							@endif
					...
					<div class="col-sm-6 col-xs-12 col-md-3 col-lg-3">
						...
						<div class="description-block">
							...
							@if (count($summaries))
								...
								<div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
									<label class="col-lg-12 col-md-12 col-sm-12 col-xs-12">{{ $summary['name'] }}</label>
									<h5 class="description-header">&nbsp;{{ $summary['this_year'] }}</h5>
								</div>
								@endforeach
							@endif
