...
Route::group(['middleware' => ['web']], function () {
    ...
    Route::post('/admins/api/credit/create',['uses'=>'CreditsController@create']);
    Route::post('/admins/api/credit/edit',['uses'=>'CreditsController@edit']);
    Route::get('/admins/api/credit/history/{id}',['uses'=>'CreditsController@history']);
    #Api-Custid
    ...
    Route::post('/admins/api/invoice-grab-pickup',['users'=>'AdminsController@postApiInvoiceGrabPickup']);
    ...
    Route::get('/admins/api/invoice/history/{id}', ['uses' => 'InvoicesController@getHistoryInvoices']);
    ...
    Route::get('/admins/api/user/fetch/{id}',['uses'=>'UsersController@fetchUser']);
