...
Route::group(['middleware' => ['web']], function () {
	...
	Route::patch('/admins/api/update_post', ['as'=>'admins_api_update_post','uses'=>'AdminsController@postApiUpdate']);
	Route::get('/admins/api/update/{id}/{api_token}/{server_at}',['as'=>'admins_api_update','uses'=>'AdminsController@getApiUpdate']);
	//Authenticated Pages
