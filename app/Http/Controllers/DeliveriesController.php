...
class DeliveriesController extends Controller
{
    ...
    public function getPickupForm(Request $request) {
        ...
        ->with('zipcode_status',$zipcode_status ? $zipcode_status : false)
        ->with('calendar_disabled',$calendar_setup ? $calendar_setip : false)
        ->with('selected_date',$selected_date ? $selected_date : false)
        ->with('selected_delivery_id',$selected_delivery_id ? $selected_delivery_id : false)
