...
<?php $__env->startSection('content'); ?>
    <br/>
    <?php echo Form::open(['action' => 'DiscountsController@postAdd','role'=>"form"]); ?>
    ...
    <div class="panel panel-default">
    	...
    	<div class="panel-body">
    		<div class="form-group <?php echo e($errors->has('company_id') ? ' has-error' : ''); ?>">
				...
				<?php echo e(Form::select('company_id',$companies,old('company_id') ? old('company_id') : Auth::user()->company_id,['class'=>"form-control"])); ?>
    		...
    		<div class="form-group <?php echo e($errors->has('name') ? ' has-error' : ''); ?>">
				...
				<?php echo e(Form::text('name',old('name'),['class'=>"form-control",'placeholder'=>'Name'])); ?>
			...
			<div class="form-group <?php echo e($errors->has('type') ? ' has-error' : ''); ?>">
				...
				<?php echo e(Form::select('type',['1'=>'Rate Discount','2'=>'Price Discount'],old('type'),['class'=>"form-control",'placeholder'=>'type'])); ?>
			...
			<div id="rate" class="form-group <?php echo e($errors->has('rate') ? ' has-error' : ''); ?>">
				...
				<?php echo e(Form::text('rate',old('rate'),['class'=>"form-control",'placeholder'=>'rate'])); ?>
			...
			<div id="price" class="form-group <?php echo e($errors->has('price') ? ' has-error' : ''); ?>">
				...
				<?php echo e(Form::text('price',old('price'),['class'=>"form-control",'placeholder'=>'price'])); ?>
			...
			<div class="form-group <?php echo e($errors->has('inventory_id') ? ' has-error' : ''); ?>">
				...
				<?php echo e(Form::select('inventory_id',$inventories,old('inventory_id'),['class'=>"form-control",'placeholder'=>'Select Inventory Group'])); ?>
			...
			<div class="form-group <?php echo e($errors->has('inventory_item_id') ? ' has-error' : ''); ?>">
				...
				<?php echo e(Form::select('inventory_item_id',$items,old('inventory_item_id'),['class'=>"form-control",'placeholder'=>'Select Item'])); ?>
			...
			<div class="form-group <?php echo e($errors->has('start_date') ? ' has-error' : ''); ?>">
				...
				<?php echo e(Form::text('start_date',old('start_date'),['class'=>"datePicker form-control",'placeholder'=>'start_date'])); ?>
			...
			<div class="form-group <?php echo e($errors->has('end_date') ? ' has-error' : ''); ?>">
				...
				<?php echo e(Form::text('end_date',old('end_date'),['class'=>"datePicker form-control",'placeholder'=>'end_date'])); ?>
