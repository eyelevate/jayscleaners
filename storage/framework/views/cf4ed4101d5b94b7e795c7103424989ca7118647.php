	...
	<div class="modal-dialog">
		<div class="modal-content">
				...
				<div class="row">
			        ...
			        <div class="form-group clearfix">
			            ...
			            <div class="col-lg-4 col-md-4 col-sm-4 col-xs-4">
			                <?php echo Form::select('hours', $hours, '4', ['id'=>'due_temp_hours','class'=>'form-control']); ?>

			            </div>
			            <div class="col-lg-4 col-md-4 col-sm-4 col-xs-4">
			                <?php echo Form::select('minutes', $minutes,'00',['id'=>'due_temp_minutes','class'=>'form-control']); ?>

			            </div>
			            <div class="col-lg-4 col-md-4 col-sm-4 col-xs-4">
			                <?php echo Form::select('ampm', $ampm, 'pm', ['id'=>'due_temp_ampm','class'=>'form-control']); ?>
			...
			<div class="modal-footer">
				<?php echo e(Form::hidden('temp_date',$turnaround_date,['id'=>'temp_date'])); ?>
