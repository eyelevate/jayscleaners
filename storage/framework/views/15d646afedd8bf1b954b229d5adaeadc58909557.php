	...
	<section class="wrapper style3 container special">
		<div id="store_hours" class="row">
			...
			<section class="clearfix col-xs-12 col-sm-12">
				<a class="btn btn-lg btn-default btn-block" href="<?php echo e(route('accounts_oneTimePayment')); ?>">One Time Payment</a>
			</section>
			<section class="clearfix col-xs-12 col-sm-12">
				<a class="btn btn-lg btn-primary btn-block" href="<?php echo e(route('accounts_memberPayment')); ?>">Membership Payment</a>
			</section>
		</div>
