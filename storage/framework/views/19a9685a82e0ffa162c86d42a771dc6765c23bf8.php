<?php echo Form::open(['action' => 'SchedulesController@postAdminCancel', 'class'=>'form-horizontal','role'=>"form",'id'=>'cancel_form']); ?>
		...
		<div class="modal-content">
			...
			<div class="modal-body clearfix">
				...
				<div class="form-group">
					...
					<div class="col-sm-8">
						<p class="form-control"><?php echo e($schedule_id); ?></p>
					</div>
				</div>
			</div>
