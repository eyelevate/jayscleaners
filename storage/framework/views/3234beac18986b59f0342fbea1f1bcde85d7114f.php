                ...
                <div class="panel-body">
                    <?php echo Form::open(['action' => 'CardsController@postEdit', 'class'=>'form-horizontal','role'=>"form"]); ?>
                        ...
                        <div class="form-group<?php echo e($errors->has('year') ? ' has-error' : ''); ?>">
                            ...
                            <div class="col-md-2">
                                <input type="text" class="form-control" name="month" value="<?php echo e(old('month') ? old('month') : sprintf('%02d', $cards->exp_month)); ?>" placeholder="MM">
                            ...
                            <div class="col-md-4">
                                <input type="text" class="form-control" name="year" value="<?php echo e(old('year') ? old('year') : $cards->exp_year); ?>" placeholder="YYYY">
