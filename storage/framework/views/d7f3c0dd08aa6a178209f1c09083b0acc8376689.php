...
<?php $__env->startSection('content'); ?>
    <?php echo Form::open(['action' => 'CustomersController@postEdit', 'class'=>'form-horizontal','role'=>"form"]); ?>

        <?php echo csrf_field(); ?>

        <?php echo Form::hidden('customer_id',$customers->id); ?>
        ...
        <div class="tab-content">
            ...
            <div class="chart tab-pane active" id="customer-instore" style="position: relative;">
                <div class="form-group<?php echo e($errors->has('company_id') ? ' has-error' : ''); ?>">
                    ...
                    <div class="col-md-6">
                        <?php echo Form::select('company_id',$companies , $customers->company_id, ['class'=>'form-control']); ?>
                ...
                <div class="form-group<?php echo e($errors->has('phone') ? ' has-error' : ''); ?>">
                    ...
                    <div class="col-md-6">
                        <?php echo Form::text('phone', $customers->phone, ['class'=>'form-control', 'placeholder'=>'']); ?>
                ...
                <div class="form-group<?php echo e($errors->has('last_name') ? ' has-error' : ''); ?>">
                    ...
                    <div class="col-md-6">
                        <?php echo Form::text('last_name', $customers->last_name, ['class'=>'form-control', 'placeholder'=>'']); ?>
                ...
                <div class="form-group<?php echo e($errors->has('first_name') ? ' has-error' : ''); ?>">
                    ...
                    <div class="col-md-6">
                        <?php echo Form::text('first_name', $customers->first_name, ['class'=>'form-control', 'placeholder'=>'']); ?>
                ...
                <div class="form-group<?php echo e($errors->has('email') ? ' has-error' : ''); ?>">
                    ...
                    <div class="col-md-6">
                        <?php echo Form::email('email', $customers->email, ['class'=>'form-control', 'placeholder'=>'']); ?>
                ...
                <div class="form-group<?php echo e($errors->has('marks') ? ' has-error' : ''); ?>">
                    <label class="col-md-4 control-label">Shirt Marks <span class="text text-danger">*</span></label>

                    <div class="col-md-2">
                        <?php echo Form::text('marks[0][mark]', (isset($marks[0])) ? $marks[0]['mark'] : null, ['class'=>'form-control', 'placeholder'=>'','disabled'=>'true']); ?>


                    </div>
                    <div class="col-md-2">
                    	<?php echo Form::hidden('marks[1][id]', (isset($marks[1])) ? $marks[1]['id'] : null); ?>

                        <?php echo Form::text('marks[1][mark]', (isset($marks[1])) ? $marks[1]['mark'] : null, ['class'=>'form-control', 'placeholder'=>'']); ?>


                    </div>
                    <div class="col-md-2">
                    	<?php echo Form::hidden('marks[2][id]', (isset($marks[2])) ? $marks[2]['id'] : null); ?>

                        <?php echo Form::text('marks[2][mark]', (isset($marks[2])) ? $marks[2]['mark'] : null, ['class'=>'form-control', 'placeholder'=>'']); ?>
                ...
                <div class="form-group<?php echo e($errors->has('starch') ? ' has-error' : ''); ?>">
                    ...
                    <div class="col-md-6">
                        <?php echo Form::select('starch', $starch , $customers->starch, ['class'=>'form-control']); ?>
                ...
                <div class="form-group<?php echo e($errors->has('hanger') ? ' has-error' : ''); ?>">
                    ...
                    <div class="col-md-6">
                        <?php echo Form::select('hanger', $hanger, $customers->shirt, ['class'=>'form-control']); ?>
                ...
                <div class="form-group<?php echo e($errors->has('important_memo') ? ' has-error' : ''); ?>">
                    ...
                    <div class="col-md-6">
                        <?php echo Form::text('important_memo', (old('important_memo')) ? old('important_memo') : $customers->important_memo, ['class'=>'form-control', 'placeholder'=>'']); ?>
                ...
                <div class="form-group<?php echo e($errors->has('invoice_memo') ? ' has-error' : ''); ?>">
                    ...
                    <div class="col-md-6">
                        <?php echo Form::text('invoice_memo', (old('invoice_memo')) ? old('invoice_memo') : $customers->invoice_memo, ['class'=>'form-control', 'placeholder'=>'']); ?>
            ...
            <div class="chart tab-pane" id="customer-delivery" style="position: relative;">
                <div class="form-group<?php echo e($errors->has('delivery') ? ' has-error' : ''); ?>">
                    ...
                    <div class="col-md-6">
                        <?php echo Form::select('delivery',$delivery , (old('delivery')) ? old('delivery') : $customers->delivery, ['class'=>'form-control']); ?>
                ...
                <div class="form-group<?php echo e($errors->has('mobile') ? ' has-error' : ''); ?>">
                    ...
                    <div class="col-md-6">
                        <?php echo Form::text('mobile', (old('mobile')) ? old('mobile') : $customers->mobile, ['class'=>'form-control', 'placeholder'=>'']); ?>
...
<!--                 <div class="form-group<?php echo e($errors->has('street') ? ' has-error' : ''); ?>">
                    ...
                    <div class="col-md-6">
                        <?php echo Form::text('street', (old('street')) ? old('street') : $customers->street, ['class'=>'form-control', 'placeholder'=>'']); ?>
            ...
            <div class="chart tab-pane" id="customer-account" style="position: relative;">
                <div class="form-group<?php echo e($errors->has('account') ? ' has-error' : ''); ?>">
                    ...
                    <div class="col-md-6">
                        <?php echo Form::select('account',$account , old('account') ? old('account') : $customers['account'], ['class'=>'form-control']); ?>
                ...
                <div class="form-group<?php echo e($errors->has('suite') ? ' has-error' : ''); ?>">
                    ...
                    <div class="col-md-6">
                        <?php echo Form::text('suite', (old('suite')) ? old('suite') : $customers->suite, ['class'=>'form-control', 'placeholder'=>'']); ?>
                ...
                <div class="form-group<?php echo e($errors->has('city') ? ' has-error' : ''); ?>">
                    ...
                    <div class="col-md-6">
                        <?php echo Form::text('city', (old('city')) ? old('city') : $customers->city, ['class'=>'form-control', 'placeholder'=>'']); ?>
                ...
                <div class="form-group<?php echo e($errors->has('zipcode') ? ' has-error' : ''); ?>">
                    ...
                    <div class="col-md-6">
                        <?php echo Form::text('zipcode', (old('zipcode')) ? old('zipcode') : $customers->zipcode, ['class'=>'form-control', 'placeholder'=>'']); ?>
