<div id="invoiceModal-<?php echo e($invoice_id); ?>" class="modal fade" tabindex="-1" role="dialog">
	<div class="modal-dialog">
		<div class="modal-content">
			<div class="modal-header">
				<button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
				<h4 class="modal-title">View Invoice Items [<strong><?php echo e(str_pad($invoice_id, 6, '0', STR_PAD_LEFT)); ?></strong>]</h4>
			</div>
			<div class="modal-body">
				<table id="itemTable-<?php echo e($invoice_id); ?>" class="itemTable no-padding clearfix table table-striped" style="list-style:none;">
					<thead>
						<tr>
							<th>#</th>
							<th>Name</th>
