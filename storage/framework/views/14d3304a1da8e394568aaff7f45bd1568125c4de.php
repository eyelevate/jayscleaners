...
<br/>
<?php echo Form::open(['action' => 'CardsController@postAdminsEdit', 'class'=>'form-horizontal','role'=>"form"]); ?>

    <?php echo csrf_field(); ?>

    <?php echo Form::hidden('id',$cards->id); ?>
...
<div class="panel panel-default">
    ...
    <div class="panel-body">
	    <div class="form-group<?php echo e($errors->has('first_name') ? ' has-error' : ''); ?>">
	        ...
	        <div class="col-md-6">
	            <input type="text" class="form-control" name="first_name" value="<?php echo e(old('first_name') ? old('first_name') : $first_name); ?>" placeholder="e.g. John">
	    ...
	    <div class="form-group<?php echo e($errors->has('last_name') ? ' has-error' : ''); ?>">
	        ...
	        <div class="col-md-6">
	            <input type="text" class="form-control" name="last_name" value="<?php echo e(old('last_name') ? old('last_name') : $last_name); ?>" placeholder="e.g. Doe">
	    ...
	    <div class="form-group<?php echo e($errors->has('street') ? ' has-error' : ''); ?>">
	        ...
	        <div class="col-md-6">
	            <input type="text" class="form-control" name="street" value="<?php echo e(old('street') ? old('street') : $cards->street); ?>" placeholder="e.g. 12345 1st Ave. N">
	    ...
	    <div class="form-group<?php echo e($errors->has('suite') ? ' has-error' : ''); ?>">
	        ...
	        <div class="col-md-6">
	            <input type="text" class="form-control"  name="suite" value="<?php echo e(old('suite') ? old('suite') : $cards->suite); ?>" placeholder="e.g. 201A">
	    ...
	    <div class="form-group<?php echo e($errors->has('city') ? ' has-error' : ''); ?>">
	        ...
	        <div class="col-md-6">
	            <input type="text" class="form-control"  name="city" value="<?php echo e(old('city') ? old('city') : $cards->city); ?>" placeholder="e.g. Seattle">
	    ...
	    <div class="form-group<?php echo e($errors->has('state') ? ' has-error' : ''); ?>">
	        ...
	        <div class="col-md-6">
	            ...
	            <?php echo e(Form::select('state',$states,old('state') ? old('state') : $cards->state,['class'=>'form-control'])); ?>
	    ...
	    <div class="form-group<?php echo e($errors->has('zipcode') ? ' has-error' : ''); ?>">
	        ...
	        <div class="col-md-6">
	            <input type="text" class="form-control" name="zipcode" value="<?php echo e(old('zipcode') ? old('zipcode') : $cards->zipcode); ?>" placeholder="e.g. 98115">
	    ...
	    <div class="form-group<?php echo e($errors->has('card') ? ' has-error' : ''); ?>">
	        ...
	        <div class="col-md-6">
	            <input type="text" class="form-control" name="card" value="<?php echo e(old('card')); ?>" placeholder="<?php echo e($card_number); ?>">
	    ...
	    <div class="form-group<?php echo e($errors->has('year') ? ' has-error' : ''); ?>">
	        ...
	        <div class="col-md-4">
	            <input type="text" class="form-control" name="year" value="<?php echo e(old('year') ? old('year') : $cards->exp_year); ?>" placeholder="format. YYYY">
	        ...
	        <div class="col-md-2">
	            <input type="text" class="form-control" name="month" value="<?php echo e(old('month') ? old('month') : sprintf('%02d', $cards->exp_month)); ?>" placeholder="format. MM">
