<section id="services" class="wrapper style3 container special clearfix">
	<header class="major">
	...
	<div class="row">
		<div class="4u 12u(narrower)">
			...
			<section class="read_articles">
				...
				<header class="clearfix col-xs-12 col-sm-12 col-md-12 col-lg-12" style="padding:0px;">
	...
	<div class="row">
		<div class="4u 12u(narrower)">
			...
			<section class="read_articles">
				...
				<header class="clearfix col-xs-12 col-sm-12 col-md-12 col-lg-12" style="padding:0px;">
					<h5 class="wrapper style2 special-alt col-xs-12 col-sm-12 col-md-12 col-lg-12" style="padding-top:5px; padding-bottom:5px; margin-bottom:10px;">Household</h5>
				</header>
		...
		<div class="4u 12u(narrower)">
			<section class="read_articles">
				...
				<header class="clearfix col-xs-12 col-sm-12 col-md-12 col-lg-12" style="padding:0px;">
					<h5 class="wrapper style2 special-alt col-xs-12 col-sm-12 col-md-12 col-lg-12" style="padding-top:5px; padding-bottom:5px; margin-bottom:10px;">Rugs</h5>
				</header>
				<p>
					Area and Oriental rugs are a beautiful addition to any home. 
					Like well-placed wall decor or fine paintings, they contribute to the overall character and complete the furnishing of a well-decorated room. 
					Unlike wall decor, however, area rugs usually receive a fair amount of traffic. 
					Rugs like this are often put down in high-traffic areas to decorate, liven up and even protect these living spaces. 
					But who is going to protect the rugs? 
					Similar to carpets and upholstered furniture, area rugs act as air filters for the home, trapping dirt, allergens and bacteria and preventing those unhealthy elements from circulating to other rooms. 
					But area rugs are only able to do this properly if they are maintained and kept clean. Just as an air filter for your home ventilation system needs to be regularly replaced, your carpets, upholstery, and area rugs need to be regularly cleaned. 
					We provide high quality area rug cleaning services, focusing on care and attention to detail, that restore the rugs to their original beauty while removing dirt and allergens.
				</p>
		...
		<div class="4u 12u(narrower)">
			<section class="read_articles">
				...
				<header class="clearfix col-xs-12 col-sm-12 col-md-12 col-lg-12" style="padding:0px;">
					<h5 class="wrapper style2 special-alt col-xs-12 col-sm-12 col-md-12 col-lg-12" style="padding-top:5px; padding-bottom:5px; margin-bottom:10px;">Leather</h5>
				</header>
				<p>
					At Jays Cleaners we want to provide you with the ability to clean every type of garment in your closet. 
					In order to accommodate your needs we have partnerned with LeatherCare of Seattle for over 30 years.
					We work in close relationship with them to ensure that every need for your leather, fur, suede garmet has been met.
				</p>
				<p>
					We do leave it to the experts, but have partnered with them to get you the very best pricing around. 
					You will be able to drop off and pick up your leather and suede items at any of our convenient locations. 
					We will take care of the rest. Due to working with the experts, this will take longer then our normal quick turnaround, however your items will be returned to you looking new! 				
				</p>
			</section>
	...
	<br/>
	<br/>
	<a href="<?php echo e(route('pages_pricing')); ?>" class="button">Pricing List</a>
