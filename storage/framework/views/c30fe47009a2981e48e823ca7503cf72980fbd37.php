...
<?php echo Form::open(['action' => 'InventoryItemsController@postAdd', 'class'=>'form-horizontal','role'=>"form"]); ?>
		...
		<div class="modal-content">
			...
			<div class="modal-body">
                ...
                <div class="form-group<?php echo e($errors->has('inventory_id') ? ' has-error' : ''); ?>">
                    ...
                    <div class="col-md-6">
                        <?php echo Form::select('inventory_id',$group_select , '', ['class'=>'form-control']); ?>
                ...
                <div class="form-group<?php echo e($errors->has('tags') ? ' has-error' : ''); ?>">
                    ...
                    <div class="col-md-6">
                        <?php echo Form::select('tags',$tags_select , '1', ['class'=>'form-control']); ?>
                ...
                <div class="form-group<?php echo e($errors->has('image') ? ' has-error' : ''); ?>">
                    ...
                    <div id="imageSelected" class="hide">
                    	<?php echo e(Form::hidden('image','',['id'=>'image_selected'])); ?>
