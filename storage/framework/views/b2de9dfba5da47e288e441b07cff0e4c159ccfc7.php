...
<?php $__env->startSection('content'); ?>
	<?php echo Form::open(['action' => 'AdminsController@postAdd', 'class'=>'form-horizontal','role'=>"form"]); ?>
		...
		<div class="panel panel-default">
			...
			<div class="panel-body">
                <div class="form-group<?php echo e($errors->has('username') ? ' has-error' : ''); ?>">
                    ...
                    <div class="col-md-6">
                    	<?php echo Form::text('username', old('username'), ['class'=>'form-control', 'placeholder'=>'']); ?>
