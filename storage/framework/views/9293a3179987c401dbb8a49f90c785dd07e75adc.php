...
<script type="text/javascript">
    ...
    $('#pickupdate').Zebra_DatePicker({
        ...
        format:'D m/d/Y',
        disabled_dates: ['<?php echo e($calendar_disabled); ?>'],
...
<?php $__env->startSection('content'); ?>
    <div class="row">
        <div id="bc1" class="btn-group btn-breadcrumb col-lg-12 col-md-12 col-sm-12 col-xs-12">
            ...
            <a href="<?php echo e(route('delivery_pickup')); ?>" class="btn btn-default active col-lg-4 col-md-4 col-sm-4 col-xs-12" style="height:160px;">
            ...
            <a href="<?php echo e(route('delivery_dropoff')); ?>" class="btn btn-default col-lg-4 col-md-4 col-sm-4 col-xs-12 disabled" disabled="true" style="height:160px">
            ...
            <a href="<?php echo e(route('delivery_confirmation')); ?>" class="btn btn-default col-lg-4 col-md-4 col-sm-4 col-xs-12 disabled" disabled="true" style="height:160px">
                    ...
                    <div id="pickup_body" class="panel-body">                   
                        ...
                        <div class="form-group<?php echo e($errors->has('pickup_date') ? ' has-error' : ''); ?> pickup_date_div ">
                            ...
                            <div id="pickup_container" class="col-md-6">
                                ...
                                <input id="pickupdate" type="text" class="datepicker form-control" name="pickup_date" value="<?php echo e((old('pickup_date')) ? old('pickup_date') : ($selected_date) ? date('D m/d/Y',strtotime($selected_date)) : ''); ?>" style="background-color:#ffffff;">
                                <?php else: ?>
