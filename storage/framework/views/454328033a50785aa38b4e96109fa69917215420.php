		...
		<div class="box box-primary">
			...
			<div class="box-body" style="">
				<div class="form-horizontal">
                    ...
                    <div class="form-group<?php echo e($errors->has('account_total') ? ' has-error' : ''); ?>">
                        <label class="col-md-4 control-label">Account Total</label>

                        <div class="col-md-6">
                            <input type="text" class="form-control" name="account_total" value="<?php echo e(money_format('$%i',$customers->account_total)); ?>" disabled="true" style="font-size:20px; background-color:#ffffff;">
                        </div>
                    </div>
                    ...
                    <div class="form-group<?php echo e($errors->has('credits') ? ' has-error' : ''); ?>">
                        ...
                        <div class="col-md-6">
                            <input type="text" class="form-control" name="account" value="<?php echo e(money_format('$%i',$customers->credits)); ?>" disabled="true" style="font-size:20px; background-color:#ffffff;">
                        </div>
                    </div>
                    <div class="form-group<?php echo e($errors->has('credits') ? ' has-error' : ''); ?>">
                        <label class="col-md-4 control-label"></label>
			...
			<div class="box-body table-responsive">
				<table id="invoiceTable" class="table table-hover table-striped">
                    ...
                    <?php if(isset($invoices)): ?>
                        ...
                        <tr id="invoiceTr-<?php echo e($invoice->id); ?>" class="invoiceTr " invoice-id="<?php echo e($invoice->id); ?>" data-toggle="modal" data-target="#invoiceModal-<?php echo e($invoice->id); ?>" style="<?php echo e($invoice->status_color ? 'color:'.$invoice->status_color : ''); ?>">
