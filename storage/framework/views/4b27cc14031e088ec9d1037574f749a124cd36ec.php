		...
		<table class="table table-hover table-condensed table-striped">
			...
			<tbody>
				<tr>
					...
					<td>(<?php echo e($reports['total_splits']['cash']['discount']); ?>)</td>
				...
				<tr>
					...
					<td>(<?php echo e($reports['total_splits']['credit']['discount']); ?>)</td>
				...
				<tr>
					...
					<td>(<?php echo e($reports['total_splits']['online']['discount']); ?>)</td>
				...
				<tr>
					...
					<td>(<?php echo e($reports['total_splits']['check']['discount']); ?>)</td>
				...
				<tr>
					...
					<td><?php echo e($reports['total_splits']['account']['subtotal']); ?></td>
					<td>(<?php echo e($reports['total_splits']['account']['discount']); ?>)</td>
					<td><?php echo e($reports['total_splits']['account']['tax']); ?></td>
					<td><?php echo e($reports['total_splits']['account']['total']); ?></td>
				</tr>
			</tbody>
			<tfoot>
				<tr>
