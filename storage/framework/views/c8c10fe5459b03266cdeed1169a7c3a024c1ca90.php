		...
		<div class="box box-primary">
			<div class="box-body table-responsive">
				<table id="invoiceSummaryTable" class="table table-hover">
					...
					<tbody>
					<?php if(isset($invoice_grouped)): ?>
						<?php $idx = 0;?>
						<?php foreach($invoice_grouped as $key => $value): ?>
						<?php $idx++; ?>
						<tr id="invoiceTr-<?php echo e($key); ?>" class="invoiceTr <?php echo e(($idx == 1) ? 'success' : ''); ?>" item-id="<?php echo e($key); ?>" qty="" style="cursor:pointer;">
							<td class="itemTr-qty"><?php echo e($value['qty']); ?></td>
							<td class="itemTr-name"><?php echo e($value['name']); ?></td>
							<td class="itemTr-color"><?php echo e(trim($value['colors'],", ")); ?></td>
							<td class="itemTr-memo"><?php echo e(trim($value['memos'],", ")); ?></td>
...
<?php echo Form::open(['action' => 'InvoicesController@postEdit','id'=>'invoice-form', 'class'=>'form-horizontal','role'=>"form"]); ?>

<?php echo csrf_field(); ?>

<?php echo e(Form::hidden('invoice_id',$invoice_id)); ?>
...
<?php if(isset($invoice_items)): ?>
	...
	<div class="hide formItemsDiv" item-idx="<?php echo e($idx); ?>" item-id="<?php echo e($item->item_id); ?>">
		...
		<input class="invoiceItem-memo" type="hidden" value="<?php echo e($item->memo); ?>" name="item[<?php echo e($item->inventory_id); ?>][<?php echo e($idx); ?>][<?php echo e($item->item_id); ?>][memo]" item-idx="<?php echo e($idx); ?>" item-id="<?php echo e($item->item_id); ?>"/>
