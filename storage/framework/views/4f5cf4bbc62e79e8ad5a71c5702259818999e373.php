		...
		<div class="modal-content">
			...
			<div class="modal-body clearfix">
	            <div class="form-group<?php echo e($errors->has('amount_due') ? ' has-error' : ''); ?>">
                    ...
                    <div class="col-md-12">   
                        <?php echo e(Form::text('amount_due','0.00',['class'=>'amount_due form-control','readonly'=>'true'])); ?>
                ...
                <div class="form-group<?php echo e($errors->has('payment_id') ? ' has-error' : ''); ?>">
                    ...
                    <div class="col-md-12">
                        ...
                        <?php echo e(Form::select('payment_id',$cards,old('payment_id'),['id'=>'payment_id','class'=>'form-control'])); ?>
